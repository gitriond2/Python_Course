...
def app():
    ...
    hc.options.title.text = "Averange Rating by Month"
    hc.options.subtitle = ""

    hc.options.xAxis.categories = list(Month_group.index)
    #print(type(hc.options))                        #i have type extension for manipulate the values
    hc.options.series[0].data = list(Month_group)
